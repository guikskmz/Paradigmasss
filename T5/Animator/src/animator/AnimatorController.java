...
public class AnimatorController {
    ...
    private void createObjectSet() throws Exception {
        ...
        switch (shapeType) {
            case Oval: objs.addOval(nShapes, dim, pathShapes, c); break;
            case Rectangle: objs.addRectangles(nShapes, dim, pathShapes, c); break;
            case Circle: objs.addCircles(nShapes, dim, pathShapes, c); break;
            case Triangulo: objs.addTria(nShapes, dim, pathShapes, c); break;
        }
